"""
RPC handlers for image registration process.
"""
...
def masternode_image_upload_request(data, *args, **kwargs):
    # parse inputs
    upload_code = data['upload_code']
    image_data = data['image_data']
    mn_ticket_logger.info('Masternode image upload received, upload_code: {}'.format(upload_code))
...
RPC_HANDLER_LIST = [("REGTICKET_REQ", "REGTICKET_RESP",
                     masternode_validate_registration_ticket),
                    ("IMAGE_UPLOAD_MN0_REQ", "IMAGE_UPLOAD_MN0_RESP",
                     masternode_image_upload_request_mn0),
                    ("IMAGE_UPLOAD_REQ", "IMAGE_UPLOAD_RESP",
                     masternode_image_upload_request),
                    ("TXID_10_REQ", "TXID_10_RESP",
                     masternode_validate_txid_upload_code_image,
                     True),
